...
class MenuController extends BaseController
{
     ...
     */
     ...
     function getMenuItems()
     {
         ...
         foreach ($menuItems as $menuItem) {
             if (!$menuItem->parent_id) {
                 $menuStructure[] = buildMenuStructure($menuItem, $menuItems);
             }
         }
     ...
     function buildMenuStructure($menuItem, $menuItems)
     {
         $menuStructure = [
             'id' => $menuItem->id,
             'name' => $menuItem->name,
         ...
         foreach ($menuItems as $childMenuItem) {
             if ($childMenuItem->parent_id === $menuItem->id) {
                 $menuStructure['children'][] = buildMenuStructure($childMenuItem, $menuItems);
             }
         }
